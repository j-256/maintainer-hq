CREATE TABLE github_dependency_candidate_cache (
  ...
  result_json TEXT CHECK (result_json IS NULL OR length(CAST(result_json AS BLOB)) <= 163840),
...
CREATE TRIGGER push_repository_dependency_candidates AFTER UPDATE OF result_json ON github_dependency_candidate_cache
